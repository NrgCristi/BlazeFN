...
namespace FortniteLauncher
{
    internal class Program
    {
        ...
        static readonly string binPath = @"PathTextBox.Text";
        ...
        static string token = "used";
        static string exchange = "used";
        static string authType = "used";
        //Change this path to your ssl pinning bypass

        static void Main(string[] args)
        {
            Console.WriteLine("FortniteLauncher made by NRG Cristi");
